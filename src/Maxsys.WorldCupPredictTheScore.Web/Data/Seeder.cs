...
public static class Seeder
{
    ...
    public static async ValueTask SeedAsync(IHost host)
    {
        ...
        {
            new Match('A', 1, new DateTime(2022, 11, 20, 13, 0, 0), QAT,EQU),
            new Match('B', 1, new DateTime(2022, 11, 21, 10, 0, 0), ING,IRA),
            new Match('A', 1, new DateTime(2022, 11, 21, 13, 0, 0), SEN,HOL),
            new Match('B', 1, new DateTime(2022, 11, 21, 16, 0, 0), EUA,GAL),
            new Match('C', 1, new DateTime(2022, 11, 22, 7, 0, 0), ARG,ASA),
            new Match('D', 1, new DateTime(2022, 11, 22, 10, 0, 0), DIN,TUN),
            new Match('C', 1, new DateTime(2022, 11, 22, 13, 0, 0), MEX,POL),
            new Match('D', 1, new DateTime(2022, 11, 22, 16, 0, 0), FRA,AUS),
            new Match('F', 1, new DateTime(2022, 11, 23, 7, 0, 0), MAR,CRO),
            new Match('E', 1, new DateTime(2022, 11, 23, 10, 0, 0), ALE,JAP),
            new Match('E', 1, new DateTime(2022, 11, 23, 13, 0, 0), ESP,CRI),
            new Match('F', 1, new DateTime(2022, 11, 23, 16, 0, 0), BEL,CAN),
            new Match('G', 1, new DateTime(2022, 11, 24, 7, 0, 0), SUI,CAM),
            new Match('H', 1, new DateTime(2022, 11, 24, 10, 0, 0), URU,COR),
            new Match('H', 1, new DateTime(2022, 11, 24, 13, 0, 0), POR,GAN),
            new Match('G', 1, new DateTime(2022, 11, 24, 16, 0, 0), BRA,SER),

            new Match('B', 2, new DateTime(2022, 11, 25, 7, 0, 0), GAL,IRA),
            new Match('A', 2, new DateTime(2022, 11, 25, 10, 0, 0), QAT,SEN),
            new Match('A', 2, new DateTime(2022, 11, 25, 13, 0, 0), HOL,EQU),
            new Match('B', 2, new DateTime(2022, 11, 25, 16, 0, 0), ING,EUA),
            new Match('D', 2, new DateTime(2022, 11, 26, 7, 0, 0), TUN,AUS),
            new Match('C', 2, new DateTime(2022, 11, 26, 10, 0, 0), POL,ASA),
            new Match('D', 2, new DateTime(2022, 11, 26, 13, 0, 0), FRA,DIN),
            new Match('C', 2, new DateTime(2022, 11, 26, 16, 0, 0), ARG,MEX),
            new Match('E', 2, new DateTime(2022, 11, 27, 7, 0, 0), JAP,CRI),
            new Match('F', 2, new DateTime(2022, 11, 27, 10, 0, 0), BEL,MAR),
            new Match('F', 2, new DateTime(2022, 11, 27, 13, 0, 0), CRO,CAN),
            new Match('E', 2, new DateTime(2022, 11, 27, 16, 0, 0), ESP,ALE),
            new Match('G', 2, new DateTime(2022, 11, 28, 7, 0, 0), CAM,SER),
            new Match('H', 2, new DateTime(2022, 11, 28, 10, 0, 0), COR,GAN),
            new Match('G', 2, new DateTime(2022, 11, 28, 13, 0, 0), BRA,SUI),
            new Match('G', 2, new DateTime(2022, 11, 28, 16, 0, 0), POR,URU),

            new Match('A', 3, new DateTime(2022, 11, 29, 12, 0, 0), HOL,QAT),
            new Match('A', 3, new DateTime(2022, 11, 29, 12, 0, 0), EQU,SEN),
            new Match('B', 3, new DateTime(2022, 11, 29, 16, 0, 0), IRA,EUA),
            new Match('B', 3, new DateTime(2022, 11, 29, 16, 0, 0), GAL,ING),
            new Match('D', 3, new DateTime(2022, 11, 30, 12, 0, 0), TUN,FRA),
            new Match('D', 3, new DateTime(2022, 11, 30, 12, 0, 0), AUS,DIN),
            new Match('C', 3, new DateTime(2022, 11, 30, 16, 0, 0), POL,ARG),
            new Match('C', 3, new DateTime(2022, 11, 30, 16, 0, 0), ASA,MEX),
            new Match('F', 3, new DateTime(2022, 12, 1, 12, 0, 0), CRO,BEL),
            new Match('F', 3, new DateTime(2022, 12, 1, 12, 0, 0), CAN,MAR),
            new Match('E', 3, new DateTime(2022, 12, 1, 16, 0, 0), CRI,ALE),
            new Match('E', 3, new DateTime(2022, 12, 1, 16, 0, 0), JAP,ESP),
            new Match('H', 3, new DateTime(2022, 12, 2, 12, 0, 0), COR,POR),
            new Match('H', 3, new DateTime(2022, 12, 2, 12, 0, 0), GAN,URU),
            new Match('G', 3, new DateTime(2022, 12, 2, 16, 0, 0), CAM,BRA),
            new Match('G', 3, new DateTime(2022, 12, 2, 16, 0, 0), SER,SUI),
        });
